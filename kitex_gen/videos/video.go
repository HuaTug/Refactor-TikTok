...
type VideoPublishStartRequest struct {
	...
	ChunkTotalNumber int64  `thrift:"chunk_total_number,4" frugal:"4,default,i64" json:"chunk_total_number"`
}
...
func (p *VideoPublishStartRequest) writeField4(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("chunk_total_number", thrift.I64, 4); err != nil {
		goto WriteFieldBeginError
	}
...
func (p *VideoPublishStartRequest) DeepEqual(ano *VideoPublishStartRequest) bool {
	...
	if !p.Field4DeepEqual(ano.ChunkTotalNumber) {
		return false
	}
	return true
}
...
func (p *VideoPublishStartRequest) Field4DeepEqual(src int64) bool {
